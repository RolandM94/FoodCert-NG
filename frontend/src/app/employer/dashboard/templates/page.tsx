...
export default function EmployerDashboardTemplatesPage() {
  return (
    <PortalShell
      role="employer"
    ...
    >
      <DashboardTemplateGallery initialModuleSource="employers" canvasBuilderHref="/employer/dashboard/canvas-builder" />
    </PortalShell>
  );
}
