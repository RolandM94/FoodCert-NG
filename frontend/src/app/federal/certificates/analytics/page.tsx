    ...
    <PortalShell role="federal_admin" title="Certificate analytics" description="Aggregate trust monitoring for federal oversight, with sensitive certificate details kept out of the default view.">
      <div className="grid gap-5">
        <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={label} className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm">
              <Activity className="mb-3 text-brand-700" size={18} />
        ...
        <section className="grid gap-3">
          <div className="flex items-center gap-2"><BarChart3 className="text-brand-700" size={18} /><h2 className="text-base font-bold text-neutral-900">Issuance by state</h2></div>
          <DataTable
            columns={[
        ...
        <section className="grid gap-3">
          <div className="flex items-center gap-2"><AlertTriangle className="text-warning-700" size={18} /><h2 className="text-base font-bold text-neutral-900">High-risk facilities</h2></div>
          <DataTable
            columns={[
