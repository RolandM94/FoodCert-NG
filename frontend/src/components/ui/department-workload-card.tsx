  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm font-bold text-slate-950">{departmentName}</p>
      ...
      <div className="mt-3 flex items-center gap-3">
        <div className="flex items-center gap-2 rounded bg-amber-50 px-3 py-2">
          ...
          <div>
            <p className="text-lg font-bold text-amber-800">{formatNumber(pendingTasks)}</p>
            <p className="text-[10px] font-semibold text-amber-600">Pending</p>
          </div>
        </div>
        <div className="flex items-center gap-2 rounded bg-emerald-50 px-3 py-2">
          <CheckCircle2 size={14} className="text-emerald-600" />
          <div>
            <p className="text-lg font-bold text-emerald-800">{formatNumber(completedTasks)}</p>
