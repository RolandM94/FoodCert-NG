...
export function OrganizationProfileForm({
  ...
  return (
    ...
    >
      ...
      {error && (
        <p className="mt-4 rounded bg-red-50 px-3 py-2 text-sm font-semibold text-red-700">{error}</p>
      )}
      ...
      <div className="mt-5 flex items-center gap-3">
        <button
          type="submit"
          disabled={loading}
          className="inline-flex h-10 items-center gap-2 rounded bg-brand-green px-4 text-sm font-bold text-white hover:bg-brand-deep disabled:opacity-60"
        >
