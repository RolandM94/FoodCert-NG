  ...
  return (
    <form className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm" onSubmit={handleSubmit}>
      <div className="mb-4 flex items-center gap-2">
        <MessageSquarePlus className="text-brand-deep" size={18} />
        <h2 className="text-base font-bold text-slate-950">Submit Response</h2>
      </div>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="grid gap-1.5 text-sm font-semibold text-slate-700">
          Evidence link
          <input
            className="h-11 rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm"
            placeholder="https://..."
            type="url"
            value={evidenceUrl}
      ...
      <label className="mt-4 grid gap-1.5 text-sm font-semibold text-slate-700">
        Response note
        <textarea
          className="min-h-28 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm leading-6"
