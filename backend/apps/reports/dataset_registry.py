...
DATASET_DEFINITIONS: list[DatasetDefinition] = [
    ...
    DatasetDefinition(
        ...
        description="Canonical Performance Indicator definitions (KPI engine) with ownership, visibility, targets, and lifecycle.",
        module_source="standards",
        model_label="standards.MEIndicator",
        allowed_account_types=["federal", "state"],
        allowed_roles=[UserRole.FEDERAL_ADMIN, UserRole.STATE_ADMIN, UserRole.SUPER_ADMIN],
        available_fields=[
            "indicator_code", "indicator_name", "category", "owner_type", "visibility",
            "lifecycle_status", "unit_of_measurement", "target_direction", "target_value",
            "reporting_frequency", "data_source", "latest_value", "achievement_value",
            "last_calculated_at",
        ],
        field_labels={
            "indicator_code": "Indicator code", "indicator_name": "Indicator name",
            "category": "Category", "owner_type": "Owner", "visibility": "Visibility",
            "lifecycle_status": "Lifecycle status", "unit_of_measurement": "Unit",
            "target_direction": "Good direction", "target_value": "Target",
            "reporting_frequency": "Frequency", "data_source": "Data source",
            "latest_value": "Latest value", "achievement_value": "Achievement %",
            "last_calculated_at": "Last calculated",
        },
        field_types={
            "indicator_code": "string", "indicator_name": "string", "category": "string",
            "owner_type": "string", "visibility": "string", "lifecycle_status": "string",
            "unit_of_measurement": "string", "target_direction": "string",
            "target_value": "number_decimal", "reporting_frequency": "string",
            "data_source": "string", "latest_value": "number_decimal",
            "achievement_value": "number_decimal", "last_calculated_at": "datetime",
        },
        joinable_datasets=["performance_indicator_results"],
        aggregation_rules={"target_value": ["avg"], "latest_value": ["avg"]},
        required_permissions=["indicators.view_federal"],
        state_scope_paths=["owner_state_id"],
        sample_ordering=["indicator_name"],
        worksheet_examples=[
            {
                "key": "indicator_catalogue",
                "name": "Performance Indicator Catalogue",
                "description": "Browse indicator definitions by category and lifecycle status.",
                "recommended_for": ["federal", "state"],
                "metrics": [{"field": "indicator_code", "aggregation": "count"}],
                "dimensions": [{"field": "category"}, {"field": "lifecycle_status"}],
                "filters": [],
                "chart_recommendation": "table",
            },
        ],
        ai_prompt_hints=indicator_ai_prompt_hints("performance_indicators"),
    ),
    DatasetDefinition(
        code="performance_indicator_results",
        name="Performance Indicator Results",
        description="Calculated indicator results by period with target, variance, and performance band.",
        module_source="standards",
        model_label="standards.MEIndicatorValue",
        allowed_account_types=["federal", "state"],
        allowed_roles=[UserRole.FEDERAL_ADMIN, UserRole.STATE_ADMIN, UserRole.SUPER_ADMIN],
        available_fields=[
            "indicator__indicator_code", "indicator__indicator_name", "indicator__category",
            "period_start", "period_end", "cumulative_value_numeric", "progress_value_numeric",
            "target_value", "variance_from_target", "performance_band", "performance_severity",
            "approval_status", "value_source", "created_at",
        ],
        field_labels={
            "indicator__indicator_code": "Indicator code", "indicator__indicator_name": "Indicator name",
            "indicator__category": "Category", "period_start": "Period start", "period_end": "Period end",
            "cumulative_value_numeric": "Value", "progress_value_numeric": "Progress value",
            "target_value": "Target", "variance_from_target": "Variance", "performance_band": "Band",
            "performance_severity": "Severity", "approval_status": "Approval", "value_source": "Source",
            "created_at": "Recorded at",
        },
        field_types={
            "indicator__indicator_code": "string", "indicator__indicator_name": "string",
            "indicator__category": "string", "period_start": "date", "period_end": "date",
            "cumulative_value_numeric": "number_decimal", "progress_value_numeric": "number_decimal",
            "target_value": "number_decimal", "variance_from_target": "number_decimal",
            "performance_band": "string", "performance_severity": "string",
            "approval_status": "string", "value_source": "string", "created_at": "datetime",
        },
        joinable_datasets=["performance_indicators"],
        aggregation_rules={"cumulative_value_numeric": ["avg", "min", "max"], "period_end": ["count_by_month"]},
        required_permissions=["indicators.view_state_results"],
        sample_ordering=["-period_end"],
        worksheet_examples=[
            {
                "key": "indicator_result_trend",
                "name": "Indicator Result Trend",
                "description": "Track indicator values against target over reporting periods.",
                "recommended_for": ["federal", "state"],
                "metrics": [{"field": "cumulative_value_numeric", "aggregation": "avg"}],
                "dimensions": [{"field": "period_end"}, {"field": "indicator__indicator_name"}],
                "filters": [],
                "chart_recommendation": "line",
            },
        ],
        ai_prompt_hints=indicator_ai_prompt_hints("performance_indicator_results"),
    ),
]
